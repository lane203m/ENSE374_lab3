...
public class CheckingAccount{
	 ...
	 * Specifically, these answers and score results are for Checking Accounts
	 */
	...
	public CheckingAccount()
	{
		...
		question[0][0] = 0.25;				//high need
		question[0][1] = 0.5;				//medium
		question[0][2] = 1;					//low
		//Variable? interest?
		question[1][0] = 0;					//yes variable
		question[1][1] = 1;			   		//no variable
		question[1][2] = 0;			   		//I do not care
		//Do you want it to be most accessible?
		question[2][0] = 1;				//most accessible
		question[2][1] = 0.5;				//slightly
		question[2][2] = 0.25;					
		//Do you want to withdraw?
		question[3][0] = 1;				//often withdraw
		...
		question[5][2] = 0.25;					//no checks
		//Do you need to pay bills?
		question[6][0] = 0;					
		question[6][1] = 1;					//need to pay bills
		question[6][2] = 0;					//dont care
		//Do you mind minimum balance fees?
		question[7][0] = 0.25;				//I assume I would have them
		question[7][1] = 0.5;				//I do not mind
		question[7][2] = 1;					//I do not want large minimum balance fees
		//Is this long term savings?
		question[8][0] = 0.25;				//interest matters more
		question[8][1] = 0.5;				//yes
		question[8][2] = 1;					//no
		//Do you mind having a minimum opening balance?
		question[9][0] = 0.25;				//I assumed I'd need a large one
		question[9][1] = 0.5;				//I do not care
		question[9][2] = 1;					//I do not want a large minimum opening balance
