...
public class SavingsAccount{
	 ...
	 * Specifically, these answers and score results are for Savings Accounts
	 */
	...
	public SavingsAccount()
	{
		...
		question[2][1] = 1;				//slightly
		question[2][2] = 0.5;					
		//Do you want to withdraw?
		question[3][0] = 0.25;				//often withdraw
		question[3][1] = 1;				//sometimes
		question[3][2] = 0.5;					//
		//Do you need a debit card?
		question[4][0] = 0;						
		question[4][1] = 1;					//need debit card	
		question[4][2] = 0;					//I dont care
		//Do you need checks?
		question[5][0] = 0.5;				//yes
		question[5][1] = 1;				//a little
		...
		question[7][0] = 0.5;				//I assume I would have them
		question[7][1] = 1;				//I do not mind
		question[7][2] = 0.25;					//I do not want large minimum balance fees
		//Is this long term savings?
		question[8][0] = 0.5;				//interest matters more
		question[8][1] = 1;				//yes
		question[8][2] = 0.25;					//no
		//Do you mind having a minimum opening balance?
		question[9][0] = 0.5;				//I assumed I'd need a large one
		question[9][1] = 1;				//I do not care
